...
## @package ViewProviderFemConstraintSectionPrint
#  \ingroup FEM
#  \brief FreeCAD FEM _ViewProviderFemConstraintSectionPrint
...
class ViewProxy(view_base_femconstraint.VPBaseFemConstraint):
    """
    A View Provider for the FemConstraintSectionPrint object
    """
...
class _TaskPanel:
    """
    The TaskPanel for editing References property of FemConstraintSectionPrint objects
    """
