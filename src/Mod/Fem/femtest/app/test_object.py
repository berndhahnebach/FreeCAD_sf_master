...
class TestObjectType(unittest.TestCase):
    ...
    def test_femobjects_type(
        ...
        self.assertEqual(
            "Fem::FemSolverObjectOofem",
            type_of_obj(ObjectsFem.makeSolverOofem(doc))
        )
        self.assertEqual(
    ...
    def test_femobjects_isoftype(
        ...
        self.assertTrue(is_of_type(
            ObjectsFem.makeSolverOofem(doc),
            'Fem::FemSolverObjectOofem'
        ))
        self.assertTrue(is_of_type(
    ...
    def test_femobjects_derivedfromfem(
        ...
        # FemSolverObjectOOFEM
        solver_oofem = ObjectsFem.makeSolverOofem(doc)
        self.assertTrue(is_derived_from(
            solver_oofem,
            'App::DocumentObject'
        ))
